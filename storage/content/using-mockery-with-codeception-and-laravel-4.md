...
date: 2015-11-30
summary: Integrating Codeception with a Laravel 4.* application is not as straight forward as you might hope, especially if you need to mock API calls. Let's take a look at an approach I used recently that solved this problem.
tags:
    - Codeception
    - Laravel
    - Testing
