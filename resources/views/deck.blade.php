...
<html lang="en">
  <head>
    ...
    <link
      ...
      sizes="180x180"
      href="{{ url(asset("icon/apple-touch-icon.png")) }}"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="32x32"
      href="{{ url(asset("icon/favicon-32x32.png")) }}"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="16x16"
      href="{{ url(asset("icon/favicon-16x16.png")) }}"
    />
    ...
    <link
      rel="stylesheet"
      href="{{ url(asset("css/deck-theme.css")) }}"
      id="theme"
    />
  ...
  <body>
    <div id="logo">
      <a href="/">
        <img
          src="{{ url(asset("img/deck_logo.png")) }}"
