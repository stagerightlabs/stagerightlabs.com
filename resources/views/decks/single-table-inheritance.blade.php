...
@section("slides")
  ...
  <section>
    ...
    <ul>
      ...
      <li class="fragment">
        With
        <b>Active Record:</b>
        A very radical and unusual idea.
      </li>
    </ul>
  </section>
  ...
  <section>
    ...
    <p class="fragment">
      <br />
      The status of the record request dictates the type of actions that can be
      taken against it.
    </p>
  </section>
...
&lt;?php endforeach; ?&gt;
  ...
  <section>
    <p>
      This works, but the view code is very cluttered, and we are not even
      accounting for user access control.
    </p>
  ...
  <section>
    <p>
      By implementing STI we can ask our entity objects to define their own
      allowable actions.
    </p>
  </section>
...
&lt;?php endforeach; ?&gt;
  ...
  <section>
    ...
    <p class="fragment left">
      <b>Discriminator Column</b>
      : The table column used to determine the entity type.
    </p>
    <p class="fragment left">
      <b>Inheritance Map</b>
      : A way to associate discrimination values with php classes.
    </p>
  </section>
...
return $m;
  ...
  <section>
    ...
    <ul class="left">
      <li class="fragment">
        Eloquent will now automatically resolve entity types based on the
        discrimination value.
      </li>
      <li class="fragment">
        Collections will now contain a mix of entity types, dictated by the
        discrimination value.
      </li>
      <li class="fragment">
        Facade convenience, if you are in to that sort of thing:
        <code>RecordNew::all();</code>
      </li>
    </ul>
  </section>
  ...
  <section>
    <p>
      The Data Mapper pattern lends itself more easily to Single Table
      Inheritance
    </p>
  </section>
...
// ...
  ...
  <section>
    <p>
      STI is ideal for situations where the child entities all make use of the
  ...
  <section>
    <p>
      Adding table columns that will only be used by specific child entities is
      a warning sign.
    </p>
  ...
  <section>
    ...
    <ul class="left">
      <li>
        <a href="https://github.com/SRLabs/eloquent-sti" target="_blank">
          Eloquent STI
        </a>
        Laravel Package
      </li>
      <li>
        <a
          href="http://stagerightlabs.com/blog/single-table-inheritance"
          target="_blank"
        >
          Blog post expanding on these slides
        </a>
        at stagerightlabs.com
      </li>
      <li>
        <a
          href="http://snooptank.com/single-table-inheritance-with-eloquent-laravel-4/"
          target="_blank"
        >
      ...
      <li>
        <a
          href="http://blog.tatedavies.com/2011/09/13/setting-up-class-table-inheritance-with-doctrine-2-0"
          target="_blank"
        >
          Setting up Class Table Inheritance with Doctrine
        </a>
        <br />
        by Chris Tate-Davies
      </li>
    </ul>
  </section>
