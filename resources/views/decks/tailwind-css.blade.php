...
@section("slides")
  ...
  <section>
    ...
    <p style="font-size: 80%">
      Senior Engineer @
      <a href="https://phylos.bio">Phylos</a>
      <br />
      Owner @
  ...
  <section>
    <img
      src="{{ url(asset("img/decks/devron_baldwin_tailwind_css_tweet.png")) }}"
    />
  </section>
...
<p>This is my bio!</p>
  ...
  <section>
    ...
    <p>
      Using a palette of pre-defined classes forces you to stick within the
      parameters of your design system.
    </p>
    <aside class="notes">
...
<!--  -->
  ...
  <section>
    <img
      src="{{ url(asset("img/decks/tailwind_logo.svg")) }}"
      style="width: 250px"
    />
    <p>
  ...
  <section>
    <p>
      Tailwind is available through a CDN, however this will limit you to just
      the default styles.
    </p>
  </section>
  ...
  <section>
    ...
    <blockquote>
      ...
      rules (by transforming them into an Abstract Syntax Tree). This API can
      then be used by plugins to do a lot of useful things, e.g. to find errors
      or automatically insert vendor prefixes.
    </blockquote>
    <p>
  ...
  <section>
    ...
    <p>
      <a
        href="https://tailwindcss.com/docs/installation#4-process-your-css-with-tailwind"
      >
...
<span class="tag">#winter</span>
    ...
    <p>
      <a href="https://tailwindcss.com/docs/extracting-components">
  ...
  <section>
    ...
    <p>
      Using only the default configuration, Tailwind CSS is 477kb un-minified
      and uncompressed.
    </p>
  </section>
  ...
  <section>
    ...
    <p>
      Example:
      <a
        href="https://tailwindcss.com/docs/controlling-file-size/#setting-up-purgecss"
      >
  ...
  <section>
    ...
    <p>
      <a href="https://tailwindcss.com/docs/controlling-file-size">
  ...
  <section>
    <p>
      You will probably end up using a combination of tactics to manage your
      production builds.
    </p>
  </section>
  ...
  <section>
    ...
    <ul>
      ...
      <li>
        <a href="https://tailwindcss.com/screencasts/">Free Screencasts</a>
      </li>
      <li>
      ...
      <li>
        <a href="https://www.tailwindui.com/">UI Component Library</a>
        (Coming Soon...)
      </li>
      <li>
        <a href="https://github.com/laravel-frontend-presets/tailwindcss">
