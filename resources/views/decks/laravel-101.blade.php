...
@section("slides")
  <section>
    <a href="http://laravel.com">
      <img
        src="{{ url(asset("img/decks/laravel.png")) }}"
        alt="Laravel Logo"
      />
    </a>
  ...
  <section id="laravel-features">
    ...
    <ul>
      ...
      <li>
        Command Line Tools:
        <a href="http://laravel.com/docs/artisan">Artisan</a>
      </li>
      <li>Environments</li>
      <li>
        ORM:
        <a href="http://laravel.com/docs/eloquent">Eloquent</a>
      </li>
      <li>
        Templating:
        <a href="http://laravel.com/docs/templates">Blade</a>
      </li>
  ...
  <section>
    ...
    <aside class="notes">
      <ul>
        ...
        <li>
          As you advance in your development practices, Laravel advances with
          you.
        </li>
      </ul>
    </aside>
  ...
  <section>
    <a href="http://getcomposer.com">
      <img
        src="{{ url(asset("img/decks/logo-composer-transparent.png")) }}"
        alt="Composer"
      />
    </a>
    <h3>Composer</h3>
...
public function postLogin(Request $request)
{
  ...
  <section>
    ...
    <ul>
      <li class="fragment">
        <a href="http://laravel.com/docs">Documentation</a>
      </li>
      <li class="fragment"><a href="http://laracasts.com">Laracasts</a></li>
      <li class="fragment">
        <a href="http://laravel.io/forum">Laravel.io Forums</a>
      </li>
      <li class="fragment">
        <a href="https://leanpub.com/codebright">Code Bright</a>
        by Dayle Rees
      </li>
      <li class="fragment"><a href="http://laravel.io/chat">IRC Forums</a></li>
      <li class="fragment">
        <a href="https://twitter.com/laravelphp">@laravelphp</a>
      </li>
    </ul>
  </section>
  ...
  <section>
    <h3>Sentinel</h3>
    <br />
    Laravel Implementation of
    <a href="https://cartalyst.com/manual/sentry"><em>Sentry</em></a>
    Auth System
    <br />
    <br />
    <ul>
      <li>
        <a href="http://www.ryandurham.com/projects/sentinel">
          ryandurham.com/projects/sentinel
        </a>
      </li>
      <li>
        <a href="https://github.com/rydurham/sentinel">
