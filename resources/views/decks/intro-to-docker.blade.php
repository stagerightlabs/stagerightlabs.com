...
@section("slides")
  ...
  <section>
    <img
      src="{{ url(asset("img/decks/works_on_my_machine.jpg")) }}"
  ...
  <section>
    ...
    <p>
      A volume is a storage location that can be shared between docker
      containers and a host machine.
    </p>
  </section>
  ...
  <section>
    ...
    <p>
      A registry is a library of public (or private) images that can be pulled
      down to a local host machine.
    </p>
  </section>
  ...
  <section>
    ...
    <p>
      ...
      is the most popular image registry.
    </p>
    <p>
      You can find many open source projects hosting docker images on Docker
      Hub.
    </p>
  </section>
...
docker run -i {image-name} {command?}
    ...
    <p>
      The '-i' flag stands for "interactive". This will keep the container
      attached to your terminal session.
    </p>
  </section>
...
docker run -t {image-name} {command?}
    ...
    <p>
      The '-t' flag stands for "pseudo TTY". This will tell docker that you are
      connecting via a terminal session.
    </p>
  </section>
...
docker run -it {image-name} {command?}
    ...
    <p>
      If you want to interact with a container and see the output it generates
      you will generally want to use these two flags together.
    </p>
  </section>
...
docker run --rm {image-name} {command?}
    ...
    <p>
      The '--rm' option will automatically remove the container when the command
      finishes.
      <br />
      (Note the two dashes.)
    </p>
...
alias carbon=carbon
  ...
  <section>
    ...
    <p>
      A
      <span style="font-family: monospace">Dockerfile</span>
...
docker build .
    ...
    <p>
      ...
      <br />
      The "." indicates that we want to use the Dockerfile in the current
      directory.
    </p>
  </section>
...
docker build . -t my-image:latest
    ...
    <p>
      The '-t' option lets us tag the image with a name and a version. This is
      the name we will use when referencing the image with the "run" command.
    </p>
  </section>
  ...
  <section>
    ...
    <ul>
      ...
      <li>
        <a href="https://docs.docker.com/get-started/">Getting Started</a>
      </li>
      <li>
        <a href="https://docs.docker.com/engine/reference/commandline/run/">
          Run
  ...
  <section>
    ...
    <ul class="left">
      <li>
        <a
          href="https://www.freecodecamp.org/news/a-beginner-friendly-introduction-to-containers-vms-and-docker-79a9e3e119b/"
        >
          A Beginner Friendly Guide
        </a>
      </li>
      <li>
        <a href="https://medium.com/swlh/what-exactly-is-docker-1dd62e1fde38">
