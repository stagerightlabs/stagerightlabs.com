...
@section("slides")
  ...
  <section>
    ...
    <p style="font-size: 80%">
      Senior Engineer @
      <a href="https://firebrandtech.com">Firebrand Technologies</a>
      <br />
      Owner @
  ...
  <section>
    ...
    <p>
      A non-linear way of navigating information; the reader can link to
  ...
  <section>
    ...
    <p>
      <a href="https://archive.org/details/SelectedPapers1977/page/n7/mode/2up">
        Ted Nelson
      </a>
    </p>
  </section>
  ...
  <section>
    ...
    <ul>
      ...
      <li>
        <code>&lt;form&gt;</code>
        Allows users to udpate the state of resources on the server
      </li>
    </ul>
  </section>
  ...
  <section>
    <p>
      The desire for richer web experiences has popularized the JavaScript
  ...
  <section>
    ...
    <ul>
      ...
      <li>
        A change in the JSON response implies a change in the JS code and vice
        versa; they are tightly coupled
      </li>
      <li>
        It is likely that business logic will be duplicated between the client
        and the server
      </li>
  ...
  <section>
    ...
    <ul>
      <li>
        These days REST largely refers to a style of JSON API, but originally it
        was about an architecture for distributed hypermedia systems
      </li>
      <li>
      ...
      <li>
        The content of a response is an HTML representation of the requested
        resource
      </li>
  ...
  <section>
    <h3>Key Takeaway</h3>
    <p>
      Sending HTML over the wire unlocks a completely different way to think
  ...
  <section>
    <h3>HTMX</h3>
    <p>
      A small javascript library that aims to augment HTML just enough to enable
      richer UI experiences without letting go of the benefits of hypermedia.
    </p>
  ...
  <section>
    ...
    <p>
      You can use any server side language that can interpret headers and render
      HTML; even JavaScript!
    </p>
  </section>
  ...
  <section>
    <p>
      Hypermedia is a great choice for many websites, but doesn't make sense for
      every application
    </p>
  ...
  <section>
    ...
    <p>
      <i>Hypermedia Systems: The revolutionary ideas that empowered the Web</i>
    </p>
