  ...
  <x-card class="mb-8">
    <ul class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      <a href="{{ route('decks.show', ['laravel-101']) }}">
        <li class="col-span-1 flex flex-col text-center bg-zinc-700 hover:bg-zinc-600 rounded-lg shadow">
          <div class="flex-1 flex flex-col p-8">
            ...
            <h3 class="mt-6 text-zinc-300 text-sm leading-5 font-medium">Laravel 101</h3>
            <dl class="mt-1 grow flex flex-col justify-between">
              <dt class="sr-only">Description</dt>
              <dd class="text-zinc-400 text-sm leading-5">An introduction to Laravel</dd>
      ...
      <a href="{{ route('decks.show', ['single-table-inheritance']) }}">
        <li class="col-span-1 flex flex-col text-center bg-zinc-700 hover:bg-zinc-600 rounded-lg shadow">
          <div class="flex-1 flex flex-col p-8">
            ...
            <h3 class="mt-6 text-zinc-300 text-sm leading-5 font-medium">Single Table Inheritance</h3>
            <dl class="mt-1 grow flex flex-col justify-between">
              <dt class="sr-only">Description</dt>
              <dd class="text-zinc-400 text-sm leading-5">An introduction to STI with PHP</dd>
              <dt class="sr-only">Year</dt>
              <dd class="mt-3">
                <x-tag>2015</x-tag>
              </dd>
        ...
        <li class="col-span-1 flex flex-col text-center bg-zinc-700 hover:bg-zinc-600 rounded-lg shadow">
          <div class="flex-1 flex flex-col p-8">
            <svg version="1.1" class="w-32 h-32 mx-auto" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 300 300" >
              <g>
                <polygon class="fill-current text-zinc-200" points="182.9,26.5 150,83.6 117.1,26.5 7.4,26.5 150,273.5 292.6,26.5 	"/>
                <polygon class="fill-current text-zinc-300" points="182.9,26.5 150,83.6 117.1,26.5 64.5,26.5 150,174.7 235.5,26.5 	"/>
              </g>
            </svg>
            <h3 class="mt-6 text-zinc-300 text-sm leading-5 font-medium">The Secret Power of Renderless Vue Components</h3>
            <dl class="mt-1 grow flex flex-col justify-between">
              <dt class="sr-only">Description</dt>
              <dd class="sr-only text-zinc-400 text-sm leading-5">Use render functions to create powerful vue component functionality. </dd>
              <dt class="sr-only">Year</dt>
              <dd class="mt-3">
                <x-tag>2019</x-tag>
              </dd>
      ...
      <a href="{{ route('decks.show', ['tailwind-css']) }}">
        <li class="col-span-1 flex flex-col text-center bg-zinc-700 hover:bg-zinc-600 rounded-lg shadow">
          <div class="flex-1 flex flex-col p-8">
            ...
            <h3 class="mt-6 text-zinc-300 text-sm leading-5 font-medium">Tailwind CSS</h3>
            <dl class="mt-1 grow flex flex-col justify-between">
              <dt class="sr-only">Description</dt>
              <dd class="text-zinc-400 text-sm leading-5">An introduction to Tailwind CSS</dd>
              <dt class="sr-only">Year</dt>
              <dd class="mt-3">
                <x-tag>2019</x-tag>
              </dd>
      ...
      <a href="{{ route('decks.show', ['intro-to-docker']) }}">
        <li class="col-span-1 flex flex-col text-center bg-zinc-700 hover:bg-zinc-600 rounded-lg shadow">
          <div class="flex-1 flex flex-col p-8">
            ...
            <h3 class="mt-6 text-zinc-300 text-sm leading-5 font-medium">A Gentle Introduction to Docker</h3>
            <dl class="mt-1 grow flex flex-col justify-between">
              <dt class="sr-only">Description</dt>
              <dd class="sr-only text-zinc-400 text-sm leading-5">Power up your development workflow with Docker </dd>
              <dt class="sr-only">Year</dt>
              <dd class="mt-3">
                <x-tag>2020</x-tag>
              </dd>
      ...
      <a href="{{ route('decks.show', ['hypermedia']) }}">
        <li class="col-span-1 flex flex-col text-center bg-zinc-700 hover:bg-zinc-600 rounded-lg shadow">
          <div class="flex-1 flex flex-col p-8">
            ...
            <h3 class="mt-6 text-zinc-300 text-sm leading-5 font-medium">HTMX and Hypermedia</h3>
            <dl class="mt-1 grow flex flex-col justify-between">
              <dt class="sr-only">Description</dt>
              <dd class="sr-only text-zinc-400 text-sm leading-5">A discussion of Hypermedia as an alternative to JavaScript</dd>
              <dt class="sr-only">Year</dt>
              <dd class="mt-3">
                <x-tag>2024</x-tag>
              </dd>
