...
@section("slides")
  ...
  <section>
    <p>Scoped Slots + Renderless Components =</p>
    <p>
...
<p>Hello World!</p>
  ...
  <section>
    ...
    <p>
      The slot API we are looking at is from Vue 2.6+. If you are using an
      earlier version of Vue things will work exactly the same, but the API is
      slightly different.
    </p>
  </section>
...
props: {
  someProp: 'foobar'
    ...
    <small>
      <a
        href="https://vuejs.org/v2/guide/render-function.html#createElement-Arguments"
      >
  ...
  <section>
    ...
    <p>
      Use the Template Explorer to see how render functions are generated by Vue
      behind the scenes:
    </p>
    <p>
      <a href="https://template-explorer.vuejs.org/">
...
user: this.user
  ...
  <section>
    <p>
      "Renderless" components allow us to inject functionality that does not
      rely on specific UI/UX.
    </p>
  </section>
  ...
  <section>
    ...
    <a href="https://codesandbox.io/s/xoy96vw0o">
  ...
  <section>
    <img
      src="{{ url(asset("img/decks/advanced_vue_component_design.png")) }}"
      style="width: 60%"
    />
    <h2>
      <a href="https://adamwathan.me/advanced-vue-component-design/">
        Advanced Vue Component Design
      </a>
    </h2>
    <p>by Adam Wathan</p>
