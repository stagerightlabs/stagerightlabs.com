    ...
    <aside class="lg:mx-auto lg:w-96 xl:mx-0">
      ...
      >
        <ul role="list" class="space-y-1 text-xl">
          <li>
            <a
              href="{{ route("home") }}"
              class="{{ Route::is("home") || Route::is("article") ? "bg-zinc-400 text-red-800 dark:bg-zinc-300" : "text-zinc-600 hover:bg-zinc-400 hover:text-red-800" }} group flex gap-x-3 rounded-md p-2 pl-3 font-semibold"
            >
              Articles
            </a>
          </li>
          <li>
            <a
              href="{{ route("projects") }}"
              class="{{ Route::is("projects") ? "bg-zinc-400 text-red-800 dark:bg-zinc-300" : "text-zinc-600 hover:bg-zinc-400 hover:text-red-800" }} group flex gap-x-3 rounded-md p-2 pl-3 font-semibold"
            >
              Open Source
            </a>
          </li>
          <li>
            <a
              ...
              class="{{ Route::is("decks.index") ? "bg-zinc-400 text-red-800 dark:bg-zinc-300" : "text-zinc-600 hover:bg-zinc-400 hover:text-red-800" }} group flex gap-x-3 rounded-md p-2 pl-3 font-semibold"
            >
              Decks
            </a>
          </li>
          <li>
            <a
              href="{{ route("resume") }}"
              class="{{ Route::is("resume") ? "bg-zinc-400 text-red-800 dark:bg-zinc-300" : "text-zinc-600 hover:bg-zinc-400 hover:text-red-800" }} group flex gap-x-3 rounded-md p-2 pl-3 font-semibold"
            >
              Resume
            </a>
          </li>
          <li>
            <a
              href="{{ route("about") }}"
              class="{{ Route::is("about") ? "bg-zinc-400 text-red-800 dark:bg-zinc-300" : "text-zinc-600 hover:bg-zinc-400 hover:text-red-800" }} group flex gap-x-3 rounded-md p-2 pl-3 font-semibold"
            >
              About
            </a>
          </li>
      ...
      <div class="flex justify-around p-2">
        ...
        <a
          ...
          target="_blank"
          class="group flex w-1/3 gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-zinc-600 hover:bg-zinc-500 hover:text-red-800"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          href="https://www.linkedin.com/in/rydurham/"
          target="_blank"
          class="group flex w-1/3 gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-zinc-600 hover:bg-zinc-500 hover:text-red-800"
        >
          <svg
